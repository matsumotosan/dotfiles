...
keymap.set("n", "yc", "yy<cmd>normal gcc<CR>p")   -- current line
keymap.set("v", "C", "ygv<cmd>normal gc`>p<CR>")  -- visual block
...
-- quickfix
keymap.set("n", "<C-q>j", "<cmd>cnext<CR>")
keymap.set("n", "<C-q>k", "<cmd>cprev<CR>")
